...
function parseKelas(raw) {
  ...
  return {
    ...
    // Label manusiawi (mis. "2025 Ganjil") — dipakai FE membedakan kelas yang nama+kode+kelas-nya
    // sama tapi periode akademiknya beda (SIAK menjalankan banyak periode aktif bersamaan).
    nama_periode: trimOrNull(raw.periodeAkademik && raw.periodeAkademik.nama),
