...
/**
 * Presensi — payload item SELALU kosong. State sesi (token, geofence, roster) hidup di
 * tabel lms_attendance_sessions/lms_attendance_records (kunci kelasKuliahId+pertemuan_ke
 * dari section-nya), bukan di JSONB item ini — item cuma "penanda" ada aktivitas presensi
 * pada pertemuan ini.
 */
